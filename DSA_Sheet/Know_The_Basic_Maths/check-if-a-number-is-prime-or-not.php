...
<body class="bg-light py-4">
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-8">
        <h1><strong>Check if a number is prime or not</strong></h1>

        <div class="problem-statement">
          <p><strong>Problem Statement:</strong> Given an integer N, check whether it is prime or not. A prime number is a number that is only divisible by 1 and itself and the total number of divisors is 2.</p>
        </div>
...
<strong>Example 1:</strong> <strong>Input</strong>: N = 2
<strong>Output</strong>: True
<strong>Explanation</strong>: 2 is a prime number because it has two divisors: 1 and 2 (the number itself).

<strong>Example 2</strong>: <strong>Input:</strong> N =10
<strong>Output:</strong>False
<strong>Explanation:</strong>10 is not prime, it is a composite number because it has 4 divisors: 1, 2, 5 
and 10.
</pre>
<div class="code-block">
          ...
          <div class="section-content hidden" data-content="example0">
            <?php
              include("./animation/check-if-a-number-is-prime-or-not-video.php")
            ?>
          </div>
          </div>
          ...
          <div class="section-content hidden" data-content="brute-force">
            <div class="card shadow-sm">
              ...
              <div class="algorithm-content hidden" id="algorithm-content">
                ...
                <ul class="ps-3">
                  <li><strong>Step 1:</strong>Initialise a variable cnt to count the number of factors and set it to 0.</li>
                  <li><strong>Step 2:</strong>Start a loop from 1 to n, iterating through each number i. Inside the loop:</li> 
                    <ul class="ps-3">
                      <li>Check if n is divisible by i without any remainder.</li>
                      <li>If it is, increment the counter variable by 1.</li>
                    </ul>
                   <li><strong>Step 3:</strong>After the loop if the number of divisors is equal to 2, return true indicating the number is prime.
                      <ul class="ps-3">
                        <li>If the number of divisors is not equal to 2 (but greater), return false indicating that the number is not prime.</li>
                    </ul>
                   </li>
                </ul>
