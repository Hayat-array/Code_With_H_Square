...
<head>
  ...
  <title>Print 1 to N using Recursion</title>
...
<body class="bg-light py-4">
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-8">
        <h1><strong>Print 1 to N using Recursion</strong></h1>
        ...
        <div class="problem-statement">
          ...
          <p><strong>Problem Statement:</strong> Print from 1 to N using Recursion</p>
          <p>Since in this problem, there is no global variable that can be incremented each time we call a function, how can we keep a track of the number of integers being printed on the output screen?</p>
          <p>For this problem, we’re going to be using a function along with parameters that get incremented with each function call through which we can keep track of the integer count while printing. To understand this problem better, let us see the pseudocode below for this : </p>
...
main()
{
  ...
  f(1,n);
          ...
          <p>We can clearly see in this pseudocode that we first call the function when the value of i is 1 and then print the value of i and increment i by 1 inside the parameter of the function and make a call again. But, we know that this will go on forever as i will be increasing continuously after every function call. So, to avoid this we put a base condition that if i exceeds n, then simply terminate the current recursive call and return to the previous call.</p>
          <p>In this way, all the integers from 1 to N would get printed and as soon as we exceed the count of printing by n, the function terminates.</p>
...
<strong>Output</strong>: <br>1 <br>2 <br>3 <br>4 
</pre>
...
<span style="color:#00ffff;">#include&lt;iostream&gt;</span>
...
<span style="color:#00ffff;">void</span> func(<span style="color:#00ffff;">int</span> i, <span style="color:#00ffff;">int</span> n) {
    ...
    <span style="color:#00ffff;">cout</span> &lt;&lt; i &lt;&lt; <span style="color:#ffaa00;">endl</span>;

    <span style="color:#00ff00;">// Function call to print i till i increments to n.</span>
    func(i + 1, n);
}
...
<span style="color:#00ffff;">int</span> main() {
    ...
    <span style="color:#00ffff;">int</span> n = 4;
    func(1, n);
...
<span style="color:#00ffff;">void</span> func(<span style="color:#00ffff;">int</span> i, <span style="color:#00ffff;">int</span> n) {
    ...
    <span style="color:#00ff00;">// Base Condition.</span>
    <span style="color:#00ffff;">if</span> (i &lt; 1) <span style="color:#00ffff;">return</span>;

    <span style="color:#00ff00;">// Function call to print (n-1) integers.</span>
    func(i - 1, n);
    <span style="color:#00ffff;">printf</span>(<span style="color:#ffaa00;">"%d\n"</span>, i);
}
...
<span style="color:#00ffff;">int</span> main() {
    ...
    <span style="color:#00ffff;">return</span> <span style="color:#ffcc00;">0</span>;
                ...
                <div class="code-block-content hidden" style=" background: linear-gradient(45deg, black, #000000b0); padding:10px; border: 2px; border-radius:5px;"  id="java3-code">
                  ...
                  <pre style="overflow: hidden;"><code style="font-size: inherit; color: rgb(255 255 255); word-break: normal; padding:10px;">
<span style="color:#00ffff;">public class</span> Recursion {
    ...
    <span style="color:#00ffff;">static void</span> func(<span style="color:#00ffff;">int</span> i, <span style="color:#00ffff;">int</span> n) {
        ...
        <span style="color:#00ffff;">System.out.println</span>(i);
...
<span style="color:#00ffff;">function</span> func(i, n) {
    ...
    <span style="color:#00ffff;">console.log</span>(i);
...
<span style="color:#00ff00;">// Here, let’s take the value of n to be 4.</span>
<span style="color:#00ffff;">let</span> n = 4;
func(1, n);
</code></pre>

                </div>
                <div><strong>Output:</strong> <br>1 <br>2 <br> 3 <br>4</div>
              </div>
            </div>
...
<div class="code-block">
        ...
        <div class="mt-4">
            <h6>Alternate Approach for printing integers from 1 to N (using Backtracking)</h6>
            <p>This is an alternative approach for printing the integers from 1 to N using recursion. In the previous approach, we used forward recursion but in this approach, we will be using backward recursion. The only change from the previous approach here will be that the print line would be kept after the function call inside the recursive function contrary to the previous approach. The function would be called for printing (i-1) integers and the nth integer would be printed.</p>
...
<span style="color:#00ffff;">void</span> <span style="color:#00ffcc;">func</span>(<span style="color:#00ffff;">int</span> i, <span style="color:#00ffff;">int</span> n){
   ...
   <span style="color:#00ff00;">// Base Condition.</span>
   <span style="color:#00ffff;">if</span>(i &lt; <span style="color:#ff66cc;">1</span>) <span style="color:#00ffff;">return</span>;
...
<span style="color:#00ffff;">int</span> main() {
    ...
    <span style="color:#00ffff;">return</span> 0;
                ...
                <div class="code-block-content hidden" style=" background: linear-gradient(45deg, black, #000000b0); padding:10px; border: 2px; border-radius:5px;"  id="java-code">
                  ...
                  <pre style="overflow: hidden;"><code style="font-size: inherit; color: rgb(255 255 255); word-break: normal; padding:10px;">
<span style="color:#00ffff;">class</span> Recursion {
