...
<head>
  ...
  <title>Print N to 1 using Recursion</title>
...
<body class="bg-light py-4">
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-8">
        <h1><strong>Print N to 1 using Recursion</strong></h1>

        <div class="problem-statement">
            <h5><strong>Pre-requisite:</strong>The learner must know how to write a simple function in any language with parameters.</h5>
            <p>Now, after understanding the basics of recursion, the recursion tree, and the base case of recursion we can solve some basic problems of recursion which would strengthen our concepts and make us understand how recursion functions at its core. In this article, we’ll print integers from N to 1 without using any Global Variable but by using function parameters. </p>
          <p><strong>Problem Statement:</strong>Print from N to 1 using Recursion</p>
          <p>Since in this problem, there is no global variable that can be decremented each time we call a function, how can we keep a track of the number of integers being printed on the output screen?</p>
          <p>For this problem, we’re going to be using a function along with parameters that get decremented with each function call through which we can keep track of the integer count while printing. To understand this problem better, let us see the pseudocode below for this : </p>
...
main()
{
  ...
  f(n,n);
          ...
          <p>We can clearly see in this pseudocode that we first call the function when the value of i is n and then print the value of i and decrement i by 1 inside the parameter of the function and make a call again. But, we know that this will go on forever as i will be decreasing continuously after every function call. So, to avoid this we put a base condition that if i is less than 1, then simply terminate the current recursive call and return to the previous call.</p>
          <p>In this way, all the integers from N to 1 would get printed and as soon as the count becomes less than 1, the function terminates.</p>
          <h6>Recursion Tree for the following problem can be represented as follows :</h6>
          <img src="../../images/print_recursion.png"  width="600px" height="300px" style="border:2px solid #e6e6e6; border-radius:20px; " alt="">
        </div>
...
<strong>Example 1:</strong> <strong>Input</strong>: N = 4
<strong>Output</strong>: <br>4 <br>3 <br>2 <br>1 
</pre>
  ...
  <div class="section-content hidden" data-content="optimal2">
            <div class="code-switcher-container mt-2">
...
<span style="color:#00ffff;">#include&lt;bits/stdc++.h&gt;</span>
<span style="color:#00ffff;">using namespace std;</span>

<span style="color:#00ffff;">void</span> func(<span style="color:#00ffff;">int</span> i, <span style="color:#00ffff;">int</span> n){
   
   <span style="color:#00ff00;">// Base Condition.</span>
   <span style="color:#00ffff;">if</span>(i &lt; <span style="color:#ffcc00;">1</span>) <span style="color:#00ffff;">return</span>;
   <span style="color:#00ffff;">cout</span> &lt;&lt; i &lt;&lt; <span style="color:#00ffff;">endl</span>;

   <span style="color:#00ff00;">// Function call to print i till i decrements to 1.</span>
   func(i - <span style="color:#ffcc00;">1</span>, n);

}

<span style="color:#00ffff;">int</span> main(){
  
  <span style="color:#00ff00;">// Here, let’s take the value of n to be 4.</span>
  <span style="color:#00ffff;">int</span> n = <span style="color:#ffcc00;">4</span>;
  func(n, n);
  <span style="color:#00ffff;">return</span> <span style="color:#ffcc00;">0</span>;
...
<span style="color:#00ffff;">void</span> func(<span style="color:#00ffff;">int</span> i, <span style="color:#00ffff;">int</span> n){
    ...
    <span style="color:#00ff00;">// Recursive call to print i down to 1</span>
    func(i - <span style="color:#ffcc00;">1</span>, n);
}

<span style="color:#00ffff;">int</span> main(){
    
    <span style="color:#00ff00;">// Let n = 4</span>
    <span style="color:#00ffff;">int</span> n = <span style="color:#ffcc00;">4</span>;
    func(n, n);
    <span style="color:#00ffff;">return</span> <span style="color:#ffcc00;">0</span>;
}
                ...
                <div class="code-block-content hidden" style=" background: linear-gradient(45deg, black, #000000b0); padding:10px; border: 2px; border-radius:5px;"  id="java3-code">
                  ...
                  <pre style="overflow: hidden;"><code style="font-size: inherit; color: rgb(255 255 255); word-break: normal; padding:10px;">
<span style="color:#00ffff;">public class</span> Main {

    <span style="color:#00ffff;">static void</span> func(<span style="color:#00ffff;">int</span> i, <span style="color:#00ffff;">int</span> n) {
    ...
    <span style="color:#00ffff;">public static void</span> main(String[] args) {
        <span style="color:#00ff00;">// Let n = 4</span>
        <span style="color:#00ffff;">int</span> n = <span style="color:#ffcc00;">4</span>;
        func(n, n);
    }
                ...
                <div class="code-block-content hidden" style=" background: linear-gradient(45deg, black, #000000b0); padding:10px; border: 2px; border-radius:5px;" id="python3-code">
                  ...
                  <pre style="overflow: hidden;"><code style="font-size: inherit; color: rgb(255 255 255); word-break: normal; padding:10px;">
<span style="color:#00ffff;">def</span> func(i, n):
    <span style="color:#00ff00;"># Base Condition</span>
    <span style="color:#00ffff;">if</span> i &lt; <span style="color:#ffcc00;">1</span>:
        <span style="color:#00ffff;">return</span>
    <span style="color:#00ffff;">print</span>(i)
    
    <span style="color:#00ff00;"># Recursive call to print i down to 1</span>
    func(i - <span style="color:#ffcc00;">1</span>, n)

<span style="color:#00ff00;"># Let n = 4</span>
n = <span style="color:#ffcc00;">4</span>
func(n, n)
</code></pre>
                </div>
                ...
                <div class="code-block-content hidden" style=" background: linear-gradient(45deg, black, #000000b0); padding:10px; border: 2px; border-radius:5px;" id="javascript3-code">
                  ...
                  <pre style="overflow: hidden;"><code style="font-size: inherit; color: rgb(255 255 255); word-break: normal; padding:10px;">
<span style="color:#00ffff;">function</span> func(i, n) {
...
<span style="color:#00ff00;">// Let n = 4</span>
<span style="color:#00ffff;">let</span> n = <span style="color:#ffcc00;">4</span>;
func(n, n);
</code></pre>

                </div>
                <div><strong>Output:</strong> <br>4 <br>3 <br> 2 <br>1</div>
              </div>
            </div>
...
main()
{
  ...
  f(1,n);
            ...
            <p>We can clearly see in this pseudocode that we first call the function when the value of i is N and then make a call again inside this function for printing (n-1) integers and after this, we print N. But, we know that this will go on forever as i will be decreasing continuously after every function call. So, to avoid this we put a base condition that if i is less than n, then simply terminate the current recursive call and return to the previous call.</p>
            <p>In this way, all the integers from 1 to N would get printed and as soon as i becomes less than n, the function call terminates.</p>
            <h6>Recursion Tree for the following approach can be represented as follows :</h6>
            <img src="../../images/print_recursion.png" width="600px" height="300px" style="border:2px solid #e6e6e6; border-radius:20px;" alt="">
        </div>
         <!-- Optimal Approach -->
                <div class="code-block">
...
<span class="keyword">void</span> func(<span class="keyword">int</span> i, <span class="keyword">int</span> n){
   <span class="comment">// Base Condition.</span>
   <span class="keyword">if</span>(i &gt; n) <span class="keyword">return</span>;
   <span class="comment">// Function call to print (i+1) integers.</span>
   func(i + 1, n);
   <span class="function">cout</span> &lt;&lt; i &lt;&lt; <span class="string">"\n"</span>;
}

<span class="keyword">int</span> main(){
   <span class="comment">// Let’s take n = 4</span>
   <span class="keyword">int</span> n = 4;
   func(1, n);
...
<span class="keyword">int</span> main() {
   ...
   <span class="keyword">return</span> 0;
                ...
                <div class="code-block-content hidden" style=" background: linear-gradient(45deg, black, #000000b0); padding:10px; border: 2px; border-radius:5px;"  id="java-code">
                  ...
                  <pre style="overflow: hidden;"><code style="font-size: inherit; color: rgb(255 255 255); word-break: normal; padding:10px;">
<span class="keyword">public class</span> Recursion {
    <span class="keyword">static void</span> func(<span class="keyword">int</span> i, <span class="keyword">int</span> n) {
        <span class="comment">// Base Condition.</span>
        <span class="keyword">if</span>(i &gt; n) <span class="keyword">return</span>;
        <span class="comment">// Function call to print (i+1) integers.</span>
        func(i + 1, n);
        <span class="function">System.out.println</span>(i);
    }
    ...
    <span class="keyword">public static void</span> main(String[] args) {
        ...
        func(1, n);
                ...
                <div class="code-block-content hidden" style=" background: linear-gradient(45deg, black, #000000b0); padding:10px; border: 2px; border-radius:5px;" id="python-code">
                  ...
                  <pre style="overflow: hidden;"><code style="font-size: inherit; color: rgb(255 255 255); word-break: normal; padding:10px;">
<span class="keyword">def</span> func(i, n):
    <span class="comment"># Base Condition.</span>
...
func(1, n)</code>
                ...
                <div class="code-block-content hidden" style=" background: linear-gradient(45deg, black, #000000b0); padding:10px; border: 2px; border-radius:5px;" id="javascript-code">
                  ...
                  <pre style="overflow: hidden;"><code style="font-size: inherit; color: rgb(255 255 255); word-break: normal; padding:10px;">
<<span class="keyword">function</span> func(i, n) {
    <span class="comment">// Base Condition.</span>
    <span class="keyword">if</span> (i &gt; n) <span class="keyword">return</span>;
    <span class="comment">// Function call to print (i+1) integers.</span>
    func(i + 1, n);
    <span class="function">console.log</span>(i);
}

<span class="keyword">let</span> n = 4;
func(1, n);</code>
</pre>
                </div>
                <div><strong>Output:</strong> <br>4 <br>3 <br> 2 <br>1</div>
