...
<head>
  ...
  <title>Reverse a given Array</title>
...
<body class="bg-light py-4">
  ...
  <div class="container-fluid">
    <div class="row">
        <div style="border-top: 1px solid #e1d9d9ff; width:75%; margin-left:320px;"></div>
      <div class="col-3 p-3 border-end">
        <b>CodeWithH-Square</b>
      </div>
      <div class="col-8">
        <h1><strong>Reverse a given Array</strong></h1>
...
<strong>Example 1:</strong> <br><strong>Input</strong>: N = 5, arr[] = {5,4,3,2,1}
<strong>Output</strong>: {1,2,3,4,5}
<strong>Explanation</strong>:Since the order of elements gets reversed the first element will
occupy the fifth position, the second element occupies the fourth position and so on.

<strong>Example 2</strong>: <br><strong>Input:</strong>N=6 arr[] = {10,20,30,40}
...
<div class="code-block">
        ...
        <div class="disclaimer">
            <h2>Solution</h2>
           <span><span style="color:red;">Disclaimer : </span>Don't jump directly to the solution, try it out yourself first.</span>
          ...
          <div class="section-content hidden" data-content="brute-force">
            <div class="card shadow-sm">
              ...
              <div class="algorithm-content hidden" id="algorithm-content">
                ...
                <img src="../../images/reverse.gif" style="width: 40vw; height: 25vw;" alt="">                
              </div>
            </div>
...
<div class="code-block">
          ...
          <div class="section-content hidden" data-content="example1">
            <strong>Time Complexity: O(N) </strong> single-pass for reversing array.
            <div><strong>Space Complexity: O(N) </strong> for the extra array used.</div>
          </div>
        </div>
        </div>
        </div>
  ...
  <div class="section-content hidden" data-content="optimal2">
    <div class="card shadow-sm" style="padding:10px;">
      ...
      <div class="algorithm2-content hidden" id="algorithm2-content">
        <h6 class="fw-bold mt-3">Algorithm:</h6>
            <p class="fw-medium"><strong>Solution 2:</strong> Space-optimized iterative method</p>
            <p><strong>Approach:</strong> Unlike the previous method we use the same array to obtain the result. Follow the steps below.</p>
            <ul>
                <li>Keep a pointer p1  at the first index and another p2 at the last index of the array. </li>
                <li>Swap the elements pointed by p1 and p2, Post swapping increment p1 and decrement p2.</li>
                <li>This process is repeated for only the first n/2 elements where n is the length of array.</li>
            </ul>
            <p>Note: Swapping all the n elements instead of n/2 elements leaves the array unaltered.</p>
            <img src="../../images/reverse2.gif" style="width:60vw; height: 25vw;" alt="">
            <!-- <ul>
...
<div class="code-block">
          ...
          <div class="section-content hidden" data-content="example3">
            <strong>Time Complexity: O(N),</strong> single-pass involved.
            <div><strong>Space Complexity : O(1)</strong></div>
          </div>
        </div>
        </div>
        </div>
