...
<head>
  ...
  <title>Pattern-1: Rectangular Star Pattern</title>
...
<?php include("../../header.php"); ?>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-8">
                <div>
                    <h2><strong>Pattern-1: Rectangular Star Pattern</strong></h2>
                    <p class="mb-3">his article contains all the important pattern problems that you must solve before starting DSA. This is a part of the <span style="color:red"><u>Code With H-Square's A2Z DSA Course/Sheet</u></span></p>
                    <div class="square mb-3" onclick="toggleFill(this)"></div>
                    <p class="mb-3"><strong>Problem Statement:</strong> Given an integer <strong>N</strong>, print the following pattern.</p>
                    <img src="https://static.takeuforward.org/wp/uploads/2023/01/Screenshot-2023-01-23-000952.png" alt class="wp-image-7316">
                </div>
                <div>
                    <h5><strong>Examples:</strong></h5>
                    <pre style="margin-bottom:-3rem"><strong>
Example 1:
Input: N = 3
Output: 
* * *
...
* * * * * *
                ...
                <div>
                    ...
                    <p><i><span style="color:red;">Disclaimer:</span> Don't jump directly to the solution, try it out yourself first.</i></p>
                </div>
                <div>
                   <a href="https://www.geeksforgeeks.org/problems/square-pattern/1?utm_source=youtube&utm_medium=collab_striver_ytdescription&utm_campaign=pattern_1"><u style="color:red">Problem Link</u></a> 
                </div>
                <div class="mb-3">
                    <h4>Approach: </h4>
                    <ul>
                ...
                <div>
                     <p>In this problem, we run the outer loop for N times as we have to print N rows, and since we have to print a right-angled triangle/pyramid which must be upright, the inner loop will run for the row number in each iteration. For eg: 1 star for row 1, 5 stars for row 5, and so on.</p>
                </div>
                <!-- yaha code likhna hai  -->
                 <div class="container my-5">
                    <div class="card shadow">
                        <h3 class="mb-4 text-start">Pattern-1</h3>
                        <div class="text-center mb-3 card-header d-flex justify-content-between align-items-center">
                         ...
                         <!-- C++ Code -->
                            <div id="CodeCpp" class="code-content">
                                <div id="CodeCpp1" class="code-box">
                                      ...
                                      <br>
                                      <div><span class="keyword">void</span> <span class="function">pattern1</span>(<span class="keyword">int</span> N) {</div>
                                      ...
                                      <div class="comment">    // This is the inner loop which here, loops for the columns</div>
                                      <div class="comment">    // as we have to print a rectangular pattern.</div>
                                      <div>    <span class="keyword">for</span> (<span class="keyword">int</span> j = 0; j &lt; N; j++) {</div>
                                      <div>      cout &lt;&lt; <span class="string">"* "</span>;</div>
                                      <div>    }</div>
                                      <div class="comment">    // After printing N stars, go to the next line</div>
                                      <div>    cout &lt;&lt; endl;</div>
                                      <div>  }</div>
                                      <div>}</div>
                                      <br>
                            ...
                            <div id="codeJava" class="code-content d-none">
                                    <div class="code-box text-light p-4">
                                        <div id="CodeJava1" class="code-box">
                                            <span class="e-line"><span class="keyword">class</span> <span class="class-name">Main</span> {</span>
                                            <span class="code-line">    <span class="keyword">static void</span> <span class="function">pattern1</span>(<span class="keyword">int</span> N) {</span>
                                            <span class="code-line">        <span class="keyword">for</span> (<span class="keyword">int</span> i = 0; i &lt; N; i++) {</span>
                                            <span class="code-line">            <span class="keyword">for</span> (<span class="keyword">int</span> j = 0; j &lt; N; j++) {</span>
                                            <span class="code-line">                <span class="class-name">System</span>.out.print(<span class="string">"* "</span>);</span>
                                            ...
                                            <span class="code-line">        pattern1(N);</span>
                                            <span class="code-line">    }</span>
                                            <span class="code-line">}</span>
                                        </div>
                                    </div>
