...
<head>
  ...
  <title>Pattern - 16: Alpha-Ramp Pattern</title>
</head>
  <style>
        svg{
            cursor: pointer;
...
<body class="bg-light py-4">
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-8">
        <div>
          <h2><strong>Pattern - 16: Alpha-Ramp Pattern</strong></h2>
...
F F F F F F
  ...
  <div class="card shadow">
    ...
    <div class="text-center mb-3 card-header d-flex justify-content-between align-items-center">
      ...
      <div>
        <button id="CopyCppBtn" onclick="copyCode('CodeCpp16')" class="btn btn-sm btn-primary copy-btn">Copy</button>
        <button id="CopyJavaBtn" onclick="copyCode('CodeJava16')" class="btn btn-sm btn-success copy-btn d-none">Copy</button>
      </div>
    </div>

    <!-- C++ Code Block -->
    <div id="CodeCpp" class="code-content">
      <div id="CodeCpp16" class="code-box">
        <div><span class="keyword">#include</span> &lt;bits/stdc++.h&gt;</div>
        <div><span class="keyword">using namespace</span> std;</div>
        <br>
        <div><span class="keyword">void</span> <span class="function">pattern16</span>(<span class="keyword">int</span> N) {</div>
        ...
        <div>    <span class="comment">// Define the character for the current row</span></div>
        <div>    <span class="keyword">char</span> ch = 'A' + i;</div>
        <div>    <span class="comment">// Print the same character i+1 times</span></div>
    ...
    <div id="codeJava" class="code-content d-none">
      <div id="CodeJava16" class="code-box">
        <div><span class="keyword">public class</span> <span class="class-name">Main</span> {</div>
        <br>
        <div>  <span class="comment">// Method to print the character triangle pattern</span></div>
        <div>  <span class="keyword">static void</span> <span class="function">pattern16</span>(<span class="keyword">int</span> N) {</div>
        <div>    <span class="comment">// Outer loop for the number of rows</span></div>
        <div>    <span class="keyword">for</span> (<span class="keyword">int</span> i = 0; i &lt; N; i++) {</div>
        <div>      <span class="comment">// Define the character for the current row</span></div>
        <div>      <span class="keyword">char</span> ch = (char) ('A' + i);</div>
        <div>      <span class="comment">// Print the same character i+1 times</span></div>
        <div>      <span class="keyword">for</span> (<span class="keyword">int</span> j = 0; j &lt;= i; j++) {</div>
