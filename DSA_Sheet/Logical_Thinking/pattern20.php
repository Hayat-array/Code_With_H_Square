...
<head>
  ...
  <title>Pattern - 20: Symmetric-Butterfly Pattern</title>
</head>
  <style>
        svg{
            cursor: pointer;
...
<body class="bg-light py-4">
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-8">
        <div>
          <h2><strong>Pattern - 20: Symmetric-Butterfly Pattern</strong></h2>
          ...
          <p class="mb-3"><strong>Problem Statement:</strong> Given an integer <strong>N</strong>, print the following
            pattern.</p>
          <img src="https://static.takeuforward.org/wp/uploads/2023/02/image-24.png" alt class="wp-image-7549"
  ...
  <div class="card shadow">
    ...
    <div id="CodeCpp" class="code-content">
      <div id="CodeCpp19" class="code-box">
        ...
        <br>
        <div><span class="keyword">void</span> <span class="function">butterflyPattern</span>(<span class="keyword">int</span> n) {</div>
        <div>  <span class="comment">// Upper half</span></div>
        ...
        <div>    <span class="comment">// Spaces</span></div>
        <div>    <span class="keyword">for</span> (<span class="keyword">int</span> j = 1; j &lt;= 2*(n-i); j++) cout &lt;&lt; " ";</div>
        <div>    <span class="comment">// Stars</span></div>
        <div>    <span class="keyword">for</span> (<span class="keyword">int</span> j = 1; j &lt;= i; j++) cout &lt;&lt; "*";</div>
        <div>    cout &lt;&lt; endl;</div>
        <div>  }</div>
        <div>  <span class="comment">// Lower half</span></div>
        <div>  <span class="keyword">for</span> (<span class="keyword">int</span> i = n; i &gt;= 1; i--) {</div>
        <div>    <span class="comment">// Stars</span></div>
        <div>    <span class="keyword">for</span> (<span class="keyword">int</span> j = 1; j &lt;= i; j++) cout &lt;&lt; "*";</div>
        <div>    <span class="comment">// Spaces</span></div>
        <div>    <span class="keyword">for</span> (<span class="keyword">int</span> j = 1; j &lt;= 2*(n-i); j++) cout &lt;&lt; " ";</div>
    ...
    <div id="CodeJava" class="code-content d-none">
      <div id="CodeJava19" class="code-box">
        ...
        <div>  <span class="keyword">static void</span> <span class="function">butterflyPattern</span>(<span class="keyword">int</span> n) {</div>
        <div>    <span class="comment">// Upper half</span></div>
        <div>    <span class="keyword">for</span> (<span class="keyword">int</span> i = 1; i &lt;= n; i++) {</div>
        <div>      <span class="comment">// Stars</span></div>
        <div>      <span class="keyword">for</span> (<span class="keyword">int</span> j = 1; j &lt;= i; j++) System.out.print("*");</div>
        <div>      <span class="comment">// Spaces</span></div>
        <div>      <span class="keyword">for</span> (<span class="keyword">int</span> j = 1; j &lt;= 2*(n-i); j++) System.out.print(" ");</div>
        <div>      <span class="comment">// Stars</span></div>
        <div>      <span class="keyword">for</span> (<span class="keyword">int</span> j = 1; j &lt;= i; j++) System.out.print("*");</div>
