...
<head>
  ...
  <title>Pattern-5: Inverted Right Pyramid</title>
</head>
  <style>
        svg{
            cursor: pointer;
...
<body class="bg-light py-4">
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-8">
        <div>
          <h2><strong>Pattern-5: Inverted Right Pyramid</strong></h2>
          ...
          <p class="mb-3"><strong>Problem Statement:</strong> Given an integer <strong>N</strong>, print the following
            pattern.</p>
          <img src="https://static.takeuforward.org/wp/uploads/2023/02/image-9.png" alt class="wp-image-7549"
...
*
        ...
        <div>
          <p>In this pattern, we run the outer loop for N times as we have to print N rows and since we have to print a
            right-angled triangle/pyramid which must be inverted, the inner loop will run in decreasing order of stars,
            for eg: Row 1 (i=0) would contain N stars, Row 2 (i=1) would contain (N -1) stars and so on.</p>
        </div>
        <!-- yaha code karna hai  -->
        <div class="container my-5">
          <div class="card shadow">
            <h3 class="mb-4 text-start">Pattern-5</h3>
            ...
            <div id="CodeCpp" class="code-content">
              <div id="CodeCpp5" class="code-box">
                ...
                <br>
                <div><span class="keyword">void</span> <span class="function">pattern5</span>(<span
                ...
                <div class="comment"> // We print stars in decreasing order each row</div>
            ...
            <div id="codeJava" class="code-content d-none">
              <div class="code-box text-light p-4">
                <div id="CodeJava5" class="code-box">
                  ...
                  <span class="code-line"> <span class="keyword">static void</span> <span
                      class="function">pattern5</span>(<span class="keyword">int</span> N) {</span>
                  ...
                  <span class="code-line"> <span class="comment">// Inner loop to print decreasing number of
                      stars</span></span>
                  ...
                  <span class="code-line"> <span class="class-name">System</span>.out.println(); <span
                      class="comment">// Move to next line after each row</span></span>
                  <span class="code-line"> }</span>
                  <span class="code-line"> }</span>
                  <br>
                  ...
                  <span class="code-line"> <span class="keyword">int</span> N = <span class="number">5</span>; <span
                      class="comment">// You can also take user input here</span></span>
                  <span class="code-line"> pattern5(N);</span>
                  <span class="code-line"> }</span>
                  <span class="code-line">}</span>
                </div>
              </div>
