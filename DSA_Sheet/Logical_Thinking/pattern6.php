...
<head>
  ...
  <title>Pattern - 6: Inverted Numbered Right Pyramid</title>
</head>
  <style>
        svg{
            cursor: pointer;
...
<body class="bg-light py-4">
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-8">
        <div>
          <h2><strong>Pattern - 6: Inverted Numbered Right Pyramid</strong></h2>
          ...
          <p class="mb-3"><strong>Problem Statement:</strong> Given an integer <strong>N</strong>, print the following
            pattern.</p>
          <img src="https://static.takeuforward.org/wp/uploads/2023/02/image-10.png" alt class="wp-image-7549"
...
1
        ...
        <div>
          <p>In this pattern, we run the outer loop for N times as we have to print N rows and since we have to print a
            right-angled triangle/pyramid which must be inverted, so the inner loop will run from 1 to (N-i)th integer
            in every row till we reach the Nth row where only ‘1’ would be left to get printed. For eg: in the 1st-row
            numbers from 1 to N get printed, in the 2nd-row numbers from 1 to (N-1) get printed, and so on.</p>
        </div>
        <!-- yaha code karna hai  -->
        <div class="container my-5">
          <div class="card shadow">
            <h3 class="mb-4 text-start">Pattern-6</h3>
            ...
            <div id="CodeCpp" class="code-content">
              <div id="CodeCpp6" class="code-box">
                ...
                <br>
                <div><span class="keyword">void</span> <span class="function">pattern6</span>(<span
                ...
                <div class="comment"> // Inner loop to print numbers from 1 to (N-i)</div>
                <div> <span class="keyword">for</span> (<span class="keyword">int</span> j = N; j &gt; i; j--) {</div>
                <div> cout &lt;&lt; N - j + 1 &lt;&lt; <span class="string">" "</span>;</div>
                <div> }</div>
                ...
                <div class="comment"> // We have taken N = 5. You can also take input from user.</div>
            ...
            <div id="codeJava" class="code-content d-none">
              <div class="code-box text-light p-4">
                <div id="CodeJava6" class="code-box">
                  ...
                  <span class="code-line"> <span class="keyword">static void</span> <span
                      class="function">pattern6</span>(<span class="keyword">int</span> N) {</span>
                  ...
                  <span class="code-line"> <span class="comment">// Print numbers from 1 to (N-i)</span></span>
                  <span class="code-line"> <span class="keyword">for</span> (<span class="keyword">int</span> j = N; j&gt; i; j--) {</span>
                  <span class="code-line"> <span class="class-name">System</span>.out.print((N - j + 1) + <span
                  ...
                  <span class="code-line"> <span class="keyword">int</span> N = <span class="number">5</span>; <span
                      class="comment">// You can also take user input</span></span>
                  <span class="code-line"> pattern6(N);</span>
                  <span class="code-line"> }</span>
                  <span class="code-line">}</span>
                </div>
              </div>
