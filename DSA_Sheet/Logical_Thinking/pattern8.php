...
<head>
  ...
  <title>Pattern - 8: Inverted Star Pyramid</title>
</head>
  <style>
        svg{
            cursor: pointer;
...
<body class="bg-light py-4">
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-8">
        <div>
          <h2><strong>Pattern - 8: Inverted Star Pyramid</strong></h2>
          ...
          <p class="mb-3"><strong>Problem Statement:</strong> Given an integer <strong>N</strong>, print the following
            pattern.</p>
          <img src="https://static.takeuforward.org/wp/uploads/2023/02/image-12.png" alt class="wp-image-7549"
   ...
   ***** 
    ***    
     *
        ...
        <div>
          <p>In this particular pattern, we run the outer loop for N times as we have to print N rows as usual. Now, the
            question arises what will be the logic behind the inner loop?</p>
        </div>
        <div>
          <p>Similar to the last pattern, we can clearly observe that for each row there are some spaces that get
            printed then some stars, and then again some spaces giving it an inverse pyramidal look. For eg: In the
            first row (i=0) there are 0 spaces, 9 stars, then again 0 spaces. In the second row (i=1) there is 1 space,
            7 stars, then again 1 space so we can say that there are i spaces, 2*N - (2*i+1) stars, and then again i
            space for each row where i is the row index. We thus simply run 3 inner loops, first for printing the
            spaces, then the stars, and then the spaces again.</p>
        </div>
        <!-- yaha code karna hai  -->
        <div class="container my-5">
          <div class="card shadow">
            <h3 class="mb-4 text-start">Pattern-8</h3>
            <div class="text-center mb-3 card-header d-flex justify-content-between align-items-center">
              ...
              <div>
                <button id="CopyCppBtn" onclick="copyCode('CodeCpp8')"
                  class="btn btn-sm btn-primary copy-btn">Copy</button>
                <button id="CopyJavaBtn" onclick="copyCode('CodeJava8')"
            ...
            <div id="CodeCpp" class="code-content">
              <div id="CodeCpp8" class="code-box">
                ...
                <br>
                <div><span class="keyword">void</span> <span class="function">pattern8</span>(<span
                ...
                <div> <span class="keyword">for</span> (<span class="keyword">int</span> j = 0; j &lt; 2 * N - (2 * i +
                  1); j++) {</div>
                <div> cout &lt;&lt; <span class="string">"*"</span>;</div>
                <div> }</div>
                <div class="comment"> // Print spaces after stars (optional)</div>
                <div> <span class="keyword">for</span> (<span class="keyword">int</span> j = 0; j &lt; i; j++) {</div>
                <div> cout &lt;&lt; <span class="string">" "</span>;</div>
                <div> }</div>
                <div> cout &lt;&lt; endl;</div>
            ...
            <div id="codeJava" class="code-content d-none">
              <div class="code-box text-light p-4">
                <div id="CodeJava8" class="code-box">
                  <div><span class="keyword">class</span> <span class="class-name">Main</span> {</div>
                  <div> <span class="keyword">static void</span> <span class="function">pattern8</span>(<span
                      class="keyword">int</span> N) {</div>
                  <div> <span class="keyword">for</span> (<span class="keyword">int</span> i = 0; i &lt; N; i++) {</div>
