...
<head>
  ...
  <title>Pattern - 9: Diamond Star Pattern</title>
</head>
  <style>
        svg{
            cursor: pointer;
...
<body class="bg-light py-4">
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-8">
        <div>
          <h2><strong>Pattern - 9: Diamond Star Pattern</strong></h2>
          ...
          <p class="mb-3"><strong>Problem Statement:</strong> Given an integer <strong>N</strong>, print the following
            pattern.</p>
          <img src="https://static.takeuforward.org/wp/uploads/2023/02/image-13.png" alt class="wp-image-7549"
   ...
   ***** 
    ***    
     *
        ...
        <div>
          <p>This pattern is just a mixture of the last two patterns ( erect pyramid and inverted pyramid). Firstly, we will print the erect pyramid and then an inverted pyramid below it.</p>
        </div>
        <!-- yaha code karna hai  -->
        <div class="container my-5">
  <div class="card shadow">
    <h3 class="mb-4 text-start">Combined Pyramid Pattern (Erect + Inverted)</h3>
    <div class="text-center mb-3 card-header d-flex justify-content-between align-items-center">
      ...
      <div>
        <button id="CopyCppBtn" onclick="copyCode('CodeCpp9')" class="btn btn-sm btn-primary copy-btn">Copy</button>
        <button id="CopyJavaBtn" onclick="copyCode('CodeJava9')" class="btn btn-sm btn-success copy-btn d-none">Copy</button>
      </div>
    </div>

    <!-- C++ Code Block -->
    <div id="CodeCpp" class="code-content">
      <div id="CodeCpp9" class="code-box">
        ...
        <br>
        <div><span class="keyword">void</span> <span class="function">erect_pyramid</span>(<span class="keyword">int</span> N) {</div>
        <div>  <span class="keyword">for</span> (<span class="keyword">int</span> i = 0; i &lt; N; i++) {</div>
        <div>    <span class="comment">// Spaces before stars</span></div>
        <div>    <span class="keyword">for</span> (<span class="keyword">int</span> j = 0; j &lt; N - i - 1; j++) cout &lt;&lt; <span class="string">" "</span>;</div>
        <div>    <span class="comment">// Stars</span></div>
        <div>    <span class="keyword">for</span> (<span class="keyword">int</span> j = 0; j &lt; 2 * i + 1; j++) cout &lt;&lt; <span class="string">"*"</span>;</div>
        <div>    <span class="comment">// Spaces after stars</span></div>
        <div>    <span class="keyword">for</span> (<span class="keyword">int</span> j = 0; j &lt; N - i - 1; j++) cout &lt;&lt; <span class="string">" "</span>;</div>
        <div>    cout &lt;&lt; endl;</div>
        <div>  }</div>
        <div>}</div>
        <br>
        <div><span class="keyword">void</span> <span class="function">inverted_pyramid</span>(<span class="keyword">int</span> N) {</div>
        <div>  <span class="keyword">for</span> (<span class="keyword">int</span> i = 0; i &lt; N; i++) {</div>
        <div>    <span class="comment">// Spaces before stars</span></div>
        <div>    <span class="keyword">for</span> (<span class="keyword">int</span> j = 0; j &lt; i; j++) cout &lt;&lt; <span class="string">" "</span>;</div>
        <div>    <span class="comment">// Stars</span></div>
        <div>    <span class="keyword">for</span> (<span class="keyword">int</span> j = 0; j &lt; 2 * N - (2 * i + 1); j++) cout &lt;&lt; <span class="string">"*"</span>;</div>
        <div>    <span class="comment">// Spaces after stars</span></div>
        <div>    <span class="keyword">for</span> (<span class="keyword">int</span> j = 0; j &lt; i; j++) cout &lt;&lt; <span class="string">" "</span>;</div>
        <div>    cout &lt;&lt; endl;</div>
        <div>  }</div>
        ...
        <div>  erect_pyramid(N);</div>
        <div>  inverted_pyramid(N);</div>
    ...
    <div id="codeJava" class="code-content d-none">
      <div id="CodeJava9" class="code-box">
        <div><span class="keyword">public class</span> <span class="class-name">Main</span> {</div>
        <br>
        <div>  <span class="comment">// Method to print erect pyramid pattern</span></div>
        <div>  <span class="keyword">static void</span> <span class="function">erectPyramid</span>(<span class="keyword">int</span> N) {</div>
        <div>    <span class="keyword">for</span> (<span class="keyword">int</span> i = 0; i &lt; N; i++) {</div>
        <div>      <span class="comment">// Spaces before stars in each row</span></div>
        <div>      <span class="keyword">for</span> (<span class="keyword">int</span> j = 0; j &lt; N - i - 1; j++) System.out.print(<span class="string">" "</span>);</div>
        <div>      <span class="comment">// Stars in each row</span></div>
        <div>      <span class="keyword">for</span> (<span class="keyword">int</span> j = 0; j &lt; 2 * i + 1; j++) System.out.print(<span class="string">"*"</span>);</div>
        <div>      <span class="comment">// Spaces after stars (optional for symmetry)</span></div>
        <div>      <span class="keyword">for</span> (<span class="keyword">int</span> j = 0; j &lt; N - i - 1; j++) System.out.print(<span class="string">" "</span>);</div>
        <div>      System.out.println();</div>
        <div>    }</div>
        <div>  }</div>
        <br>
        <div>  <span class="comment">// Method to print inverted pyramid pattern</span></div>
        <div>  <span class="keyword">static void</span> <span class="function">invertedPyramid</span>(<span class="keyword">int</span> N) {</div>
        <div>    <span class="keyword">for</span> (<span class="keyword">int</span> i = 0; i &lt; N; i++) {</div>
        <div>      <span class="comment">// Spaces before stars in each row</span></div>
        <div>      <span class="keyword">for</span> (<span class="keyword">int</span> j = 0; j &lt; i; j++) System.out.print(<span class="string">" "</span>);</div>
        <div>      <span class="comment">// Stars in each row</span></div>
        <div>      <span class="keyword">for</span> (<span class="keyword">int</span> j = 0; j &lt; 2 * N - (2 * i + 1); j++) System.out.print(<span class="string">"*"</span>);</div>
        <div>      <span class="comment">// Spaces after stars (optional for symmetry)</span></div>
        <div>      <span class="keyword">for</span> (<span class="keyword">int</span> j = 0; j &lt; i; j++) System.out.print(<span class="string">" "</span>);</div>
        <div>      System.out.println();</div>
        <div>    }</div>
        ...
        <div>    <span class="keyword">int</span> N = 5;</div>
        <div>    erectPyramid(N);</div>
        <div>    invertedPyramid(N);</div>
        <div>  }</div>
        <div>}</div>
      </div>
    </div>
