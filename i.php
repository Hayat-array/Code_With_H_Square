...
<div class="container-fluid">
    ...
    <div class="p-3">
        ...
        <p class="md-3">In case you are learning DSA, you should definitely check out our free <span style="color:red"><u>A2Z DSA Course</u></span> with videos and blogs.</p>
        <p class="md-3">Conditional statements are a fundamental concept in programming that allows you to make decisions based on certain conditions. These statements enable your code to <strong>execute different blocks of code </strong>depending on whether <strong> specific conditions</strong> are met or not. In this blog post, we'll delve into the basics of<strong> conditional statements </strong>, starting with the ubiquitous <strong>if-else </strong>statement and gradually exploring more complex scenarios.</p>
        <h5><strong>The `if-else` Statement </strong></h5>
        <img src="https://static.takeuforward.org/wp/uploads/2023/09/if-else.png" alt="" style="width:500px">
        <p class="md-2"><strong>'if statement'</strong> is used to execute a block of code only if a certain condition is met. It allows us to conditionally execute code based on whether the specified condition is true.</p>
        ...
        <ul>
            <li>If the test condition in the if statement is true, a block of code inside the if block will be executed.</li>
            <li>If the test condition is false, the code inside the else block (if present) will be executed.</li>
        </ul>
    </div>
    <div class="container my-5 p-3">
        ...
        <div class="top-3 mb-3">
            <p><strong>Output: </strong> You are not an adult.</p>
            <img src="https://static.takeuforward.org/wp/uploads/2023/09/if-else-age.png" alt="" style="width:500px;">
        </div>
        <div class="mb-3">
            ...
            <p class="mb-3">As your code becomes more complex, you'll often encounter scenarios where you need to check multiple conditions. Instead of writing multiple independent if statements, you can streamline your code using else if statements.</p>
            <p class="mb-3">Let's say we want to grade students based on their marks within specific ranges:</p>
            ...
            <img src="https://static.takeuforward.org/wp/uploads/2023/09/if-else-long-1024x850.png" alt class="wp-image-12583" width="768" height="638">
            <div>
                <ul>
                ...
                <p class="mb-3">The provided code for grading based on marks is functional, but it <strong>can be simplified </strong> for better readability and maintainability. In the current code, there are <strong>several redundant comparisons</strong> of marks with specific values. For example, when checking for grades E, C, B, and A, you have to <strong> repeatedly check</strong> marks >= X && marks <= Y, which can be error-prone and hard to maintain as the grade ranges change.</p>
                <p class="mb-3">We can refactor the code, we can <strong>remove the lower bounds</strong> and check only the <strong>upper bounds</strong> for each grade as the code flow is such that we move along the conditions only after satisfying the previous one.</p>
            </div>
            <h4><b>Code:</b></h4>
            <div class="code-btn-container" >
